...
public class PerformanceReport {
    ...
    private Map<String, Double> gradeTrendByTerm; 
    ...
    public Double getAverageAssignmentScore() {
        return averageAssignmentScore;
    }

    public void setAverageAssignmentScore(Double averageAssignmentScore) {
        this.averageAssignmentScore = averageAssignmentScore;
    }

    public Map<String, Double> getGradeTrendByTerm() {
        return gradeTrendByTerm;
    }

    public void setGradeTrendByTerm(Map<String, Double> gradeTrendByTerm) {
        this.gradeTrendByTerm = gradeTrendByTerm;
    }
